    ...
    <main className="min-h-screen bg-[#F6F9FC]">
      ...
      <nav className="sticky top-0 z-50 bg-[#061A2E] text-white">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          ...
          <Link href="/training-courses" className="rounded-lg bg-[#16A34A] px-4 py-2 font-bold">
            Browse Courses
          </Link>
        </div>
      </nav>
      ...
      <div className="bg-[#061A2E] px-6 pb-6">
        <div className="max-w-4xl mx-auto">
          <div className="text-sm text-gray-400">
            <Link href="/training-courses" className="hover:text-white">Courses</Link>
            <span className="mx-2">/</span>
            <Link href={`/training-courses/${slug}`} className="hover:text-white">{course.title}</Link>
            <span className="mx-2">/</span>
