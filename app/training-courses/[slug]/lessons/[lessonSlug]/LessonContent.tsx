    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl p-6 shadow-sm">
        <div className="flex items-center justify-between gap-4">
          {prevLesson ? (
            <Link
              href={`/training-courses/${courseSlug}/lessons/${prevLesson.slug}`}
          ...
          <Link
            href={`/training-courses/${courseSlug}`}
          ...
          {nextLesson ? (
            <Link
              href={`/training-courses/${courseSlug}/lessons/${nextLesson.slug}`}
              className="flex items-center gap-2 text-[#1E4D8C] hover:underline"
            >
            ...
            <Link
              href={`/training-courses/${courseSlug}/quiz`}
