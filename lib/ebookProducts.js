...
// English and Spanish are SEPARATE products (18 total listings), each $14.99.
...
import { STUDY_GUIDE_PRICE_USD } from "./pricing";

// Shared one-time study-guide price (see lib/pricing.ts).
export const EBOOK_PRICE = STUDY_GUIDE_PRICE_USD;
